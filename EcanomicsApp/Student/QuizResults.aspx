...
<body style="background-color: #2B3A42">
    ...
    <div class="col-xs-11">  
               ...
               <asp:Label ID="ScoreID" runat="server" style="color:#ACCFCC;" Text="Result 1/10"></asp:Label><br />

                <br />
        </div>

                <label class="col-xs-11"><h5 style="color:#ACCFCC;">Question 1</h5></label>
            <div class="col-xs-11">                         
                ...
                <label class="col-xs-11"><h5 style="color:#ACCFCC;">Question 2</h5></label>
                <div class="col-xs-11">   
                ...
                <label class="col-xs-11"><h5 style="color:#ACCFCC;">Question 3</h5></label>
                <div class="col-xs-11">  
                <div id="question3Div">
                ...
                <label class="col-xs-11"><h5 style="color:#ACCFCC;">Question 4</h5></label>
                <div class="col-xs-11">  
                ...
                <label class="col-xs-11"><h5 style="color:#ACCFCC;">Question 5</h5></label>
                <div class="col-xs-11">  
                ...
                <label class="col-xs-11"><h5 style="color:#ACCFCC;">Question 6</h5></label>
                <div class="col-xs-11">  
                ...
                <label class="col-xs-11"><h5 style="color:#ACCFCC;">Question 7</h5></label>
                <div class="col-xs-11">  
                <div id="question7Div">
                ...
                <label class="col-xs-11"><h5 style="color:#ACCFCC;">Question 8</h5></label>
                <div class="col-xs-11">  
                <div id="question8Div">
                ...
                <label class="col-xs-11"><h5 style="color:#ACCFCC;">Question 9</h5></label>
                <div class="col-xs-11">  
                <div id="question9Div">
                ...
                <label class="col-xs-11"><h5 style="color:#ACCFCC;">Question 10</h5></label>
                <div class="col-xs-11">  
                <div id="question10Div">
                    ...
                    <br />
                        ...
                        <div class="col-xs-11">
                            <asp:Button ID="goHome" runat="server" Text="Retrun" OnClick="goHome_Click" />
                         </div>
                    </div>
                </div>
            </div>
